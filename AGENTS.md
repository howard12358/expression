...
Production builds exclude `posts/trash/**`, `posts/draft/**`, `posts/private-notes/*.md`, `docs/superpowers/plans/**/*.md`, and `README.md`. Do not rely on draft or plan content appearing in deployment. Keep publishable assets in `public/`, but treat `public/posts` as source originals: build-time compression targets only `.vitepress/dist/posts`, not the source images.
