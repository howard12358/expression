...
- `pnpm build` generates the production site into `.vitepress/dist`.
...
Production builds exclude `posts/trash/**`, `posts/draft/**`, `posts/private-notes/*.md`, and `README.md`. Do not rely on draft content appearing in deployment. Keep publishable assets in `public/` and ensure post frontmatter and links are valid before merging.
